...
import AOSTerminalText from "@/components/aos/AOSTerminalText";

const BOOT_STEPS = [
  { text: "INITIALIZING ARCHIVE CORE...", delay: 600, speed: 25 },
  { text: "CHECKING NETWORK INTEGRITY... OK", delay: 800, speed: 20 },
  { text: "LOADING ENCRYPTION MODULES... AES-512", delay: 700, speed: 20 },
  { text: "AUTHORIZATION REQUIRED — AWAITING CREDENTIALS", delay: 1200, speed: 15 },
];
...
export default function LandingPage() {
  ...
  useEffect(() => {
    if (booted["landing"]) setBootDone(true);
  }, [booted]);

  return (
    <>
      <AOSBoot steps={BOOT_STEPS} onComplete={handleBootComplete} pageKey="landing" alreadyBooted={bootDone} />
              ...
              {mode === "entry" ? (
                ...
                >
                  ...
                  <motion.button
                    ...
                    whileTap={{ scale: 0.98 }}
                    className="w-full py-4 font-mono text-sm tracking-widest text-blue-300 glass cipher-border rounded-lg hover:bg-blue-500/10 transition-all duration-300 hologram-btn-blue"
                  ...
                  <motion.button
                    ...
                    style={{ animation: guestMutation.isPending ? "boot-pulse 0.8s ease-in-out infinite" : "none" }}
                  >
                  ...
                  >
                    <p className="font-mono text-[10px] text-zinc-800 tracking-widest">NODE // 04 — STATUS: ONLINE</p>
                  </motion.div>
                </motion.div>
              ) : (
                <motion.div
                ...
                >
                  <form onSubmit={handleLogin} className="glass-strong rounded-lg p-8 cipher-border space-y-5">
                    ...
                    <button
                      ...
                      className="w-full py-4 font-mono text-sm tracking-widest text-blue-300 bg-blue-600/20 border border-blue-500/40 rounded-lg hover:bg-blue-600/30 transition-all duration-300 hologram-btn-blue disabled:opacity-50"
